...
from yuyu.core.component import labels
from yuyu.core.component.labels import LABEL_INSTANCES, LABEL_IMAGES, LABEL_SNAPSHOTS, LABEL_ROUTERS, LABEL_FLOATING_IPS, \
    LABEL_VOLUMES
from yuyu.core.utils.model_utils import BaseModel, TimestampMixin, PriceMixin, InvoiceComponentMixin
...
class Notification(BaseModel, TimestampMixin):
    ...
    def send(self):
        from yuyu.core.utils.dynamic_setting import get_dynamic_setting, EMAIL_ADMIN
        try:
            def textify(html):
